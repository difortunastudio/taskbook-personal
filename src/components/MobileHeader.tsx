...
const MobileHeader = () => {
  ...
  return (
    <>
      ...
      <div
        className={`md:hidden fixed top-0 right-0 bottom-0 w-[280px] bg-white shadow-2xl z-50 transform transition-transform duration-300 ease-in-out ${
                ...
                return (
                  <li key={item.href}>
                    <Link
                      ...
                      className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-all active:scale-95 min-h-[52px] ${
                        item.isActive
                          ? isSpecial

...
const RECORD_TYPES = [
  ...
  { value: 'decision', label: 'Decisión', icon: AlertCircle, color: 'bg-blue-100 text-blue-800' }
]
          ...
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-slate-600">
                {company?.name} • Cambios contables y decisiones importantes
              </p>
            </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    placeholder="ej: Reclasificación gastos Q3, Decisión nuevo freelancer..."
                    required
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    rows={4}
                    placeholder="Describe el cambio contable o la decisión tomada..."
                    required
                  />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      placeholder="ej: Acta reunión, Nº factura en Holded..."
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      placeholder="ej: holded, trimestral, urgente..."
                    />
                  </div>
                </div>
